        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/dashboard" aria-current="page" class="rounded-md bg-gray-1000 hover:bg-gray-700 px-3 py-2 text-sm font-medium text-white">Dashboard</a>
      ...
      <!-- Your content -->
        <div class="bg-white shadow sm:rounded-lg">
            ...
            <dl>
                ...
                <dd class="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">siboy@wkp.com</dd>
            </dl>
    </div>
  </main>
</div>
