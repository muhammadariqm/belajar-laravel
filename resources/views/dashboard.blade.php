    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="flex h-16 items-center justify-between">
        <div class="flex items-center">
          <div class="shrink-0">
            <img src="{{ asset("img/UTDI-logo.png") }}" alt="Your Company" class="size-8" />
          </div>
    ...
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      <!-- Your content -->
        <div class="bg-white shadow sm:rounded-lg">
            ...
            <h2 class="text-lg font-medium leading-6 text-gray-900">Welcome to the Dashboard</h2>
            <p class="mt-1 max-w-2xl text-sm text-gray-500">Here you can manage your projects, view reports, and access team settings.</p>
            </div>
            <div class="border-t border-gray-200">
            <dl class="divide-y divide-gray-200">
                <div class="px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                <dt class="text-sm font-medium text-gray-500">Total Projects</dt>
                <dd class="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">42</dd>
                </div>
                <div class="px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                <dt class="text-sm font-medium text-gray-500">Active Team Members</dt>
                <dd class="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">8</dd>
                </div>
            </dl>
            </div>
    </div>
